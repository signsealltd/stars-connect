...
def build():
    ...
    story += [heading("1. Getting started"),body("STARS Connect combines kiosk attendance, client and visitor registers, emergency roll call, management records, payroll, billing, reports, premises compliance, device health, backups and audit history."),heading("Roles and access",2)]
