...
export default async function StaffPage() {
  ...
  return <main className="shell"><Header manager /><div className="content">
    ...
    <div className="toolbar"><Link className="btn secondary" href="/dashboard/staff/tasks">Staff tasks</Link><Link className="btn secondary" href="/dashboard/staff/access">Staff access</Link><Link className="btn secondary" href="/timesheets">View Timesheets</Link><Link className="btn secondary" href="/dashboard/payroll">View Payroll History</Link></div><StaffManager />
  </div></main>;
}
