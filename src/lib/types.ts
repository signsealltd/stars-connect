...
export type LocalClockEvent={id:string;staffId:string;staffName:string;type:"CLOCK_IN"|"CLOCK_OUT";deviceId:string;deviceTimestamp:string;photoStatus:"NOT_REQUIRED"|"CAPTURED"|"UNAVAILABLE"|"PENDING_UPLOAD";offlineRecorded:boolean;transportDuty?:boolean};
export type LocalStaffPresenceEvent={id:string;staffId:string;staffName:string;type:"WENT_OFFSITE"|"RETURNED_ONSITE";deviceId:string;deviceTimestamp:string;offlineRecorded:boolean};
...
export type PendingChange={id:string;operation:"CLOCK_EVENT"|"STAFF_PRESENCE"|"ATTENDANCE"|"ROLL_CALL_ENTRY"|"VISITOR_SIGN_IN"|"VISITOR_SIGN_OUT";payload:unknown;createdAt:string;attempts:number};
