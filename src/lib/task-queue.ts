...
export const taskClosed=(status:string)=>["CONFIRMED","REVIEWED","COMPLETED","CLOSED","CANCELLED","DECLINED","APPROVED","NO_LONGER_REQUIRED","ESTIMATE_CORRECTED","VERIFIED"].includes(status);
